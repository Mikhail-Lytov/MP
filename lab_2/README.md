# Лабораторная работа N°2 - Контейнер ***map***
...
- лабораторная работа состоит из двух файлов: ***map.h*** - описание класса ***map***, прототипы методов, реализация методов;
...
[I] - 4.3.3 Сбалансированные деревья поиска

[I] - 4.3.4. Красно-чёрные деревья
